...
will add a behavior test in order to make sure that our Verticle functions as expected.
...
.Exercise15/src/test/groovy/com/redhat/labs/vertx/exercise15/MainSpec.groovy
[source, "groovy"]
----
